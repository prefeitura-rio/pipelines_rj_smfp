...
ergon_queries = {
    ...
    "tpmrj_pm_vwtpconclper ": {
        ...
        "execute_query": """
            SELECT
                GRUPOEXAME, NOMEGRUPO, SIGLAEXAME, SIGLAEXAME2,
                CHAVE, DECISAO, SIGLA_DECISAO, SIGLA_DECISAO2,
                DTATEND, MATRICULA, NOMESERVIDOR, DTCONCLUSAO
            FROM C_ERGON.TPMRJ_PM_VWTPCONCLPER
        """,
    },
}
