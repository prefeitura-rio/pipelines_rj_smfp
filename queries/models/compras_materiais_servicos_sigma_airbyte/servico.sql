SELECT
  SAFE_CAST(CD_SERV AS INT64) AS codigo_servico,
  SAFE_CAST(CD_SEQ AS INT64) AS codigo_sequencia,
  SAFE_CAST(DV AS INT64) AS digito_verificador,
  SAFE_CAST(CD_SERVICO AS STRING) AS codigo_servico,
  SAFE_CAST(DS_SERVICO AS STRING) AS descricao_servico,
  SAFE_CAST(ST_STATUS AS INT64) AS status_servico,
  ...
  SAFE_CAST(CD_ATIVIDADE_ECONOMICA AS STRING) AS codigo_atividade_economica,
  SAFE_CAST(CD_GRUPO_CAE AS INT64) AS codigo_grupo_cae,
  SAFE_CAST(CD_SUBGRUPO_CAE AS INT64) AS codigo_subgrupo_cae,
  SAFE_CAST(CD_ATIVIDADE_CAE AS INT64) AS codigo_atividade_econômica,
