SELECT
    ...
    SAFE_CAST(cd_movimentacao AS STRING) AS id_movimentcao,
    SAFE_CAST(cd_os AS STRING) AS id_organizacao_social,
    SAFE_CAST(cd_secretaria AS STRING) AS id_secretaria,
    ...
    SAFE_CAST(nr_empenho AS STRING) AS id_empenho,
